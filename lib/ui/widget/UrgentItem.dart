...
class UrgentItem extends StatefulWidget{
  Orders? orders;
  UrgentItem({required this.orders});
...
class _UrgentItem extends State<UrgentItem>{
    ...
    Alert(
      ...
      buttons: [
        DialogButton(
          ...
          height: 7.h,
          onPressed: ()  {
            homeController.updateOrderStatus(widget.orders!.id!,"accepted",context);
            Navigator.pop(context);
          },
          color: MyColors.MainColor,
          child: Text('accept'.tr(), style:  TextStyle(fontSize: 12.sp,
              fontFamily: 'lexend_bold',
              fontWeight: FontWeight.w700,
              color: Colors.white)),
        ),

                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('about_app'.tr(), style:  TextStyle(fontSize: 14.sp,
                              ...
                              color: MyColors.Dark1)),
                          SizedBox(height: 1.h,),
                          Html(data:aboutUsController.aboutAsResponse.value.data!.content??"",),
                          SizedBox(height: 2.h),
                          ...
                          GestureDetector(
                            ...
                            child: Row(
                              children: [
                                ...
                                SizedBox(width: 1.h),
                                Text(aboutUsController.socialResponse.value.data?.contactUs!.value![1].link.toString()??"",
                          ...
                          GestureDetector(
                            onTap: (){
                              launchEmail(
                                  aboutUsController.socialResponse.value.data!.contactUs!.value![0].link.toString());
                            },
                            child: Row(
                              children: [

...
class mapFilterScreen extends StatefulWidget{
  ...
  State<StatefulWidget> createState() {
    return _mapFilterScreen();
  }
}

class _mapFilterScreen extends State<mapFilterScreen>with SingleTickerProviderStateMixin{
      ...
      child: Material(
        ...
        child: ScaleTransition(
          ...
          child: Container(
            ...
            child: Padding(
              padding:  EdgeInsets.only(bottom: 2.h, top: 1.h,right: 2.h,left: 2.h),
              child: Column(
                      ...
                      Expanded(child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: Colors.white,
                            border: Border.all(color:isSelected==true && itemId==1?MyColors.MainColor2 : MyColors.Dark5,width: 1),
                          ),
                          child: Center(
                            child: Text('today'.tr(),
                      ...
                      Expanded(child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            color: Colors.white,
                            border: Border.all(color:isSelected==true && itemId==2?MyColors.MainColor2 : MyColors.Dark5,width: 1),
                      ...
                      Expanded(child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            borderRadius: BorderRadius.circular(15),
                            color: Colors.white,
                            border: Border.all(color:isSelected==true && itemId==3?MyColors.MainColor2 : MyColors.Dark5,width: 1),
                          ...
                          child: TextButton(
                            ...
                            onPressed: () async{
                              homeController.getOrders(context, "", "", "", "", deliveryDate,
                                  startDate.value, endDate.value).then((r) {
                                    /*setState(() {
                                      homeController.markersList.value.clear();
                                    });
                                WidgetsBinding.instance!
                                    .addPostFrameCallback((_) {
                                      setState(() {
                                        homeController.markersList.value.clear();
                                        homeController.onMapTapped(homeController.listOrderResponse.value.data!.orders!,context);
                                      });*/
